...
<main class="container">
    <h1 class="title">Cálculo de Fatorial</h1>
    <form class="form" action="./recebe-dados.php" method="POST">
        <div>
            <label for="">Digite um número para cálculo de seu fatorial:</label><br>
            <input class="input-valor" type="number" name="valor" required>
        </div>
