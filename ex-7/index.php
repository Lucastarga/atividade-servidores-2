...
<main class="container">
    <h1 class="title">Imprimindo sequência de acordo com o tamanho da string</h1>
    <form class="form" action="./recebe-dados.php" method="POST">
        <div>
            <label for="">Digite um pequeno número de palavras:</label><br>
            <input class="input-valor" type="text" name="valor" placeholder="Ex: Seu Nome Completo" required>
        </div>
        <div class="submit">
